...
val start_server :
  ...
  Server_process.process_data

val kill_server : violently:bool -> Server_process.process_data -> unit

val wait_for_server_exit :
  timeout_t:float -> Server_process.process_data -> bool

val wait_pid : Server_process.process_data -> int * Unix.process_status
