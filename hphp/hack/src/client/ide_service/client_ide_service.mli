...
val make : Client_ide_message.daemon_args -> t
...
val initialize_from_saved_state :
  ...
  naming_table_load_info:
    Client_ide_message.Initialize_from_saved_state.naming_table_load_info option ->
...
asynchronously. *)
val get_notifications : t -> Client_ide_message.notification Lwt_message_queue.t
